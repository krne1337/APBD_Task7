...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            var result = empData.Union(nullData);
            return result;
        }
        ...
        {
            var result = arr.GroupBy(x => x).Where(g => g.Count() % 2 != 0).Select(g => g.Key).First();
            return result;
        }
        ...
        {
            var result = Emps.SelectMany(e => Depts, (e, d) => new { Emp = e, Dept = d });
            return result;
        }
    }
